...
export default function LoginScreen() {
  ...
  async function handleSignIn() {
    ...
    try {
      ...
      // auth:login event will arrive when the deep link callback is handled.
    } catch (err) {
      console.error('[LoginScreen] initiateLogin failed:', err)
  ...
  return (
    ...
    >
      ...
      {/* After clicking, show a helpful note */}
      {isLoading && (
        <p style={{
          marginTop: 16,
          fontSize: 12,
